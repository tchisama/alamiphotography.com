...
const MyWork = (props: Props) => {
  return (
    <div className='my-20 fontcharm'>
        <h1 className='text-center text-5xl my-20 '>Check out my work</h1>
        <div className='flex gap-8 drop-shadow-xl fontroman'>

            <Link href={'/weddings'} className='flex-1  -rotate-1 group flex flex-col items-center gap-4 text-2xl '>
            ...
            <Link href={'/weddings'} className='flex-1 -translate-y-2 group flex flex-col items-center gap-4 text-2xl '>
                <div className='relative rounded-lg overflow-hidden'>
                ...
                <h2 className='text-4xl'>Editorial</h2>
            </Link>
            ...
            <Link href={'/weddings'} className='flex-1 rotate-1 group flex flex-col items-center gap-4 text-2xl '>
                ...
                <h2 className='text-4xl'>Engagements</h2>
            </Link>
