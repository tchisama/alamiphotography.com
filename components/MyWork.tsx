...
const MyWork = (props: Props) => {
  return (
    <div className='my-20 fontcharm'>
        ...
        <div className='flex md:flex-row flex-col gap-8 drop-shadow-xl fontroman'>

            <Link href={'/weddings'} className='flex-1  md:-rotate-1 group flex flex-col items-center gap-4 text-2xl '>
            ...
            <Link href={'/weddings'} className='flex-1 md:-translate-y-2 group flex flex-col items-center gap-4 text-2xl '>
                <div className='relative rounded-lg overflow-hidden'>
