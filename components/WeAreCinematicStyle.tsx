  ...
  return (
    <div className='flex bg-white md:flex-row flex-col gap-2 md:gap-0 min-h-[80vh] my-20 md:my-40 md:scale-[1.04]'>
        <div className='flex flex-1 md:bg-[rgba(238,227,222,0.64)] md:py-4 items-center justify-center'>
            <Image alt="" width={400} height={600} className='flex-1 max-w-sm aspect-[2/3] my-12' src={"https://firebasestorage.googleapis.com/v0/b/alamiphotography-b75a1.appspot.com/o/files%2F672688252%204G0A1918-min.jpg?alt=media&token=1d980f28-2581-4e51-991f-12312d837323"}  />
        </div>
