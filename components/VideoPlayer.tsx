...
<Dialog>
  ...
  <DialogContent className=' flex m-0 items-center justify-center shadow-none border-none md:w-[75vw] h-fit p-0 md:max-w-[75vw] max-h-none bg-transparent'>
  <iframe className=' md:h-[90vh] h-[80vh] w-[100vw] md:w-full'
        src={href}
