...
function HelloSection({}: Props) {
  return (
    <div className='flex gap-6 my-20 flex-col-reverse md:flex-row items-center justify-between'>
        ...
        <img className='espect-[3/4] object-cover md:rotate-2 rounded-lg shadow-2xl ' src="https://www.niallscullyphotography.com/wp-content/uploads/2022/12/Me-3-596x894.jpg"></img>
    </div>
  )
}
