    ...
    <div className='my-20 fontcharm md:px-4'>
      <div className='flex md:flex-row flex-col items-center'>
        <div className='relative flex-[2]'>
            <img className='w-full hidden md:block scale-[1.08] max-w-[100vh] ' src='https://firebasestorage.googleapis.com/v0/b/alamiphotography-b75a1.appspot.com/o/files%2F887469811%20Photo%20a%20gauche!-min.jpg?alt=media&token=ce6caedb-67c1-4755-924d-fc8ef9dcfc13'></img>
        </div>
        <div className='flex-[3] flex md:flex-row md:p-0 pt-16 flex-col gap-12 justify-center'>
            <Link href={"/"} className='md:w-[300px] w-[200px]  md:-translate-y-20 flex flex-col md:gap-2 items-center'>
                <img className='w-[180px]' src="https://firebasestorage.googleapis.com/v0/b/alamiphotography-b75a1.appspot.com/o/files%2F553804152%20TESTIMONIALS-min.jpg?alt=media&token=553b49ea-cf2d-4d5c-8351-db7dc4ddefc7" alt="" />
            ...
            <Link href={"/investment"} className='md:w-[300px] w-[200px]  md:translate-y-20 flex flex-col md:gap-2 items-center'>
                <img className='w-[180px]' src="https://firebasestorage.googleapis.com/v0/b/alamiphotography-b75a1.appspot.com/o/files%2F350238573%20EXPERIENCE-min.jpg?alt=media&token=bdd103ec-e410-457e-ae1c-4fa360397643" alt="" />
