    ...
    <div className='my-20 fontcharm'>
      <div className='flex md:flex-row flex-col items-center'>
        <div className='relative flex-[2]'>
            <img className='w-full scale-[1.08]  rounded-xl shadow-lg' src='https://www.niallscullyphotography.com/wp-content/uploads/2022/12/Eimear-Niall-277-1-scaled.jpeg?x15971'></img>
        </div>
        <div className='flex-[3] flex md:flex-row md:p-0 pt-16 flex-col gap-12 justify-center'>
            <Link href={"/"} className='md:w-[300px] w-[200px] rotate-1 md:-translate-y-20 flex flex-col md:gap-2 items-center'>
