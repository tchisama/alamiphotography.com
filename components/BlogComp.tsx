...
const BlogComp = (props: Props) => {
  return (
    <Link href={"/blog/0"} className='flex group min-h-[300px] hover:bg-[#fff] md:p-2 shadow-none hover:shadow-lg hover:scale-[1.01] flex-col gap-4 items-center pb-4 md:pb-8 rounded-xl duration-300'>
