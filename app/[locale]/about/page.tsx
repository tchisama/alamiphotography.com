  ...
  return (
    <div className="px-4 md:px-6 bg-[#fafaf8] overflow-x-hidden">
        ...
        <div className="relative nav mt-8 opacity-0 -translate-y-6">
            <img className="h-[50vh] md:h-[70vh] scale-105 w-full  object-cover mb-8 " src="https://firebasestorage.googleapis.com/v0/b/alamiphotography-b75a1.appspot.com/o/files%2F244157121%20Landscapeimage-min.jpg?alt=media&token=838ce1e6-02e4-44aa-a915-0f86b82f50c2" alt="" />
